...
- Useful for progress updates in GUI
...
| Remote Access | 22, 23, 3389 | SSH, Telnet, RDP |
| File Transfer | 20, 21, 69, 445 | FTP, TFTP, SMB |
...
**Returns**: List of raw Scapy packet objects (for PCAP export)
...
- Stores raw packets for PCAP export functionality
- Uses Scapy's sniff() function with stop_filter
